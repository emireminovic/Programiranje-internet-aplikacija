...
<head>
    ...
    <title>Moji zahtevi - BookCut</title>
    ...
    <section class="page-wrapper">
        <div class="container">
            <div class="page-card">
                        ...
                        @foreach($termini as $termin)
                            <div class="request-card">
                                ...
                                <div class="request-actions">
                                    <form action="{{ route('termini.approve', $termin->id) }}" method="POST" onsubmit="return confirm('Da li želite da prihvatite rezervaciju?')">
                                        @csrf
                                        <button type="submit" class="approve-btn">Prihvati</button>
                                    </form>

                                    <form action="{{ route('termini.reject', $termin->id) }}" method="POST" onsubmit="return confirm('Da li želite da odbijete rezervaciju?')">
                                        @csrf
                ...
                @else
                    <div class="empty-box">
                        <p>Nema zahteva za rezervaciju.</p>
                    </div>
                @endif
