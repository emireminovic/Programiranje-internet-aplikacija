...
<head>
    ...
    <title>Primljene poruke - BookCut</title>
            ...
            @if($messages->count() > 0)
                <div class="msg-list">
                    @foreach($messages as $message)
                        <div class="msg-card">
                            <p><strong>Od:</strong> {{ $message->user->name ?? 'Nepoznat korisnik' }}</p>
                            ...
                            <div class="reply-box">
                                <form action="{{ route('messages.reply', $message->id) }}" method="POST">
                                    ...
                                    <textarea name="poruka" rows="3" placeholder="Odgovori korisniku..." required></textarea>

                                    <button type="submit" class="reply-btn">Odgovori</button>
                                </form>
                            </div>
                        </div>
                    @endforeach
